...
var getShareIcon = exports.getShareIcon = function getShareIcon(site, width, height, color, theme) {
  switch (site) {
    case 'facebook':
      return _react2.default.createElement(_facebook2.default, { width: width, height: height, color: color, theme: theme });
    case 'twitter':
      return _react2.default.createElement(_twitter2.default, { width: width, height: height, color: color, theme: theme });
    case 'reddit':
      return _react2.default.createElement(_reddit2.default, { width: width, height: height, color: color, theme: theme });
    case 'linkedin':
      return _react2.default.createElement(_linkedin2.default, { width: width, height: height, color: color, theme: theme });
    case 'email':
