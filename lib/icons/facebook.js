...
const FacebookIcon = function FacebookIcon(props) {
  ...
  switch (theme) {
    ...
    case 'roundedunfilled':
      return _react2.default.createElement(
        ...
        _react2.default.createElement('path', {
          d:
            'M12 2c5.514 0 10 4.486 10 10s-4.486 10-10 10-10-4.486-10-10 4.486-10 10-10zm0-2c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm-2 10h-2v2h2v6h3v-6h1.82l.18-2h-2v-.833c0-.478.096-.667.558-.667h1.442v-2.5h-2.404c-1.798 0-2.596.792-2.596 2.308v1.692z',
        }),
      )
    case 'roundedsquare':
      return _react2.default.createElement(
    ...
    case 'square':
      return _react2.default.createElement(
        ...
        _react2.default.createElement('path', {
          d:
            'M0 0v24h24v-24h-24zm16 7h-1.923c-.616 0-1.077.252-1.077.889v1.111h3l-.239 3h-2.761v8h-3v-8h-2v-3h2v-1.923c0-2.022 1.064-3.077 3.461-3.077h2.539v3z',
        }),
      )
    default:
      return _react2.default.createElement('span', null, 'Facebook')
  }
}
